...
<div class="panel panel-default">
	<div class="panel-heading"><h2 class="panel-title"><?=dgettext("OpenVPNClientExport", "OpenVPN Shared Key Clients")?></h2></div>
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table table-striped table-hover table-condensed" id="clients">
				<thead>
					<tr>
						<td width="25%" class="listhdrr"><?=dgettext("OpenVPNClientExport", "Client Type")?></td>
						<td width="50%" class="listhdrr"><?=dgettext("OpenVPNClientExport", "Export")?></td>
					</tr>
				</thead>
				<tbody>
				</tbody>
...
<br />
<br />
<?= print_info_box(dgettext("OpenVPNClientExport", "These are shared key configurations for use in site-to-site tunnels with other routers. Shared key tunnels are not normally used for remote access connections to end users."), 'info'); ?>
